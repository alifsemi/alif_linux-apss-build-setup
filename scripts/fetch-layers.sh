...
LAYER;https://github.com/alifsemi/meta-alif.git;branch=$REL_BRANCH;tag=$REL_TAG \
LAYER;https://github.com/alifsemi/meta-alif-ensemble.git;branch=$REL_BRANCH;tag=$REL_TAG \
